...
自動狩獵期間若出戰角色死亡或死透，該帳號 runner 會暫停狩獵並嘗試回程及移動至大草原第 1 層。它會按伺服器行動時間等待、只在全隊可完成時送出移動完成，再驗證 `/huntInfo` 位置。抵達後停止 runner，角色仍需手動重生或轉生；從城鎮前往大草原的 `/move/1` 為依 zone ID 推定、尚待實際 recorder 確認，目的地不符就停止。
